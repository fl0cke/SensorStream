    ...
    companion object {
        ...
        private val mapping = mapOf(
                ...
                Sensor.TYPE_ROTATION_VECTOR to SensorMetaData(
                        Sensor.TYPE_ROTATION_VECTOR, "rotation_vector", 1, false, arrayOf("X", "Y", "Z")),
                ...
                Sensor.TYPE_GAME_ROTATION_VECTOR to SensorMetaData(
                        Sensor.TYPE_GAME_ROTATION_VECTOR, "game_rotation_vector", 3, false, arrayOf("X", "Y", "Z")),
                ...
                Sensor.TYPE_GEOMAGNETIC_ROTATION_VECTOR to SensorMetaData(
                        Sensor.TYPE_GEOMAGNETIC_ROTATION_VECTOR, "geomagnetic_rotation_vector", 3, false, arrayOf("X", "Y", "Z")),
